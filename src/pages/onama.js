...
function Onama() {
    ...
    useEffect(() => {
        fetch("http://localhost:3000/tim")
            ...
            .catch(err => console.error("Greška pri dohvatu članova tima:", err));
    }, []);
        ...
        <div>
            ...
            <main>
                ...
                <section className="nas-tim-section">
                    ...
                    }}>Upoznajte naš tim</h2>
                    <div className="kartice-tima">
                        <div className="kartica-clana">
                            <img src="/slike/Ines.png" alt="Ines" />
                            <h3>Ines</h3>
                            <p>Stručnjakinja za aromaterapiju i biljnu njegu. Donosi znanje iz botanike i ljubav prema prirodi.</p>
                        </div>
                        <div className="kartica-clana">
                            <img src="/slike/Aida1.png" alt="Aida" />
                            <h3>Aida</h3>
                            <p>Organizatorka tima i kreativna snaga marketinga. Uvijek donosi novu energiju i ideje.</p>
                        </div>
                        <div className="kartica-clana">
                            <img src="/slike/Selma.png" alt="Selma" />
                            <h3>Selma</h3>
                            <p>Inicijator projekta i stručnjakinja za prirodnu kozmetiku. Brine o kvaliteti svakog proizvoda.</p>
                        </div>
                    </div>
                </section>
