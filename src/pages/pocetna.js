            ...
            <main>
                <section className="hero-section">
                    <div className="hero-overlay">
                        <h1 style={{fontSize: "70px", color: "snow"}}>Dobrodošli u The Green Nook</h1>
                ...
                <section className="featured">
                    ...
                    <div className="featured-items">
                        {najtrazenijiProizvodi.map(({ slika, naziv, opis, cijena }, i) => (
                            <div className="item" key={`najtrazeniji-${i}`}>
                                <img src={`/slike/${slika}`} alt={naziv} />
                                <h3
                                    style={{
                                ...
                                <Link to="/proizvodi" className="button">
                                    Dodaj u korpu
                                </Link>
                            </div>
                        ))}
                ...
                <section className="featured">
                    ...
                    <div className="featured-items">
                        {noviProizvodi.map(({ slika, naziv, opis, cijena }, i) => (
